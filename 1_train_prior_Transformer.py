...
if __name__ == "__main__":
    ...
    parser.add_argument('--train-data', action='store', dest='train_data', default='data/drd2/drd_train.csv')
    parser.add_argument('--valid-data', action='store', dest='valid_data', default='data/drd2/drd_test.csv')
